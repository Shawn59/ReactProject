...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 05 2019 г., 18:00
...
--
ALTER TABLE `releases`
  ADD CONSTRAINT `releases_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
